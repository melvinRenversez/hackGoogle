...
encodings = [
    "utf-8", "utf-16", "latin-1", "ascii", "cp1252", "iso-8859-1",
    "utf-32", "utf-16le", "utf-16be", "utf-32le", "utf-32be",
    "big5", "big5hkscs", "cp037", "cp424", "cp437", "cp500", "cp720",
    ...
    "iso8859_16", "johab", "koi8_r", "koi8_t", "koi8_u", "kz1048",
    "mac_cyrillic", "mac_greek", "mac_iceland", "mac_latin2", "mac_roman",
    "mac_turkish", "ptcp154", "shift_jis", "shift_jis_2004", "shift_jisx0213",
    "utf_32_le", "utf_32_be", "utf_16_le", "utf_16_be", "utf_7", "utf_8_sig"
]

for encoding in encodings:
    try:
        encoded_text = text.encode(encoding)
        print(f"Encodage {encoding}: {encoded_text}")
